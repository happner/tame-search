...
function unsubscribeAll(options) {
  ...
  var unsubscribeResults = this.getAllTopics().reduce(function(reduceTo, topic){
...
function unsubscribe(topic, options) {
  ...
  if (typeof topic !== 'string' || topic[0] != '/') throw new Error('topic must be a string and must start with /');
...
function searchAll(options){
  ...
  return _this.getAllTopics().reduce(function(reduceTo, topic){
